...
from PyQt6.QtWidgets import QHeaderView, QAbstractItemView, QToolButton, QMenu

from src.constant.table_constant import OPERATION_HEADER_LABEL, ROW_OPERATION_TEXT, ROW_OPERATION_ICON, \
    ROW_CAT_EDIT_ICON, ROW_CAT_EDIT_TEXT, ROW_DEL_ICON, ROW_DEL_TEXT
