...
class WorkTaskManagerTableWidget(CustomTableWidget):
    ...
    def do_fill_row(self, row_index, row_data, fill_create_time=True):
        self.setItem(row_index, 1, self.make_project_item(row_data.project_info))
        self.setItem(row_index, 2, self.make_item(row_data.task_name))
        ...
        self.setItem(row_index, 7, self.make_item(row_data.start_time))
        self.setItem(row_index, 8, self.make_item(row_data.end_time))
        self.setItem(row_index, 9, self.make_item(row_data.time_duration))
        self.setItem(row_index, 10, self.make_data_dict_item(row_data.publish_status))
