# -*- coding: utf-8 -*-
from PyQt6.QtWidgets import QLabel, QStackedWidget, QHBoxLayout, QSpacerItem

from src.constant.window_constant import SAVE_DATA_TIPS
