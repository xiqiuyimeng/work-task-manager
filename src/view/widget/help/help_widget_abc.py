...
from PyQt6.QtWidgets import QFrame, QFormLayout, QLabel

from src.constant.help_constant import MULTI_LINE_LABEL_STYLE, TEXT_BROWSER_STYLE
from src.view.custom_widget.scrollable_widget import ScrollArea, ScrollableTextBrowser

_author_ = 'luwt'
_date_ = '2023/7/10 15:02'
